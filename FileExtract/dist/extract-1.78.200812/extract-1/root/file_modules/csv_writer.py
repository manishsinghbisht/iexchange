...
def write_extract_csv_file(batch_count = None, file_output_location = None, file_name = None, col_names = None, delimiter = ',', shall_quote=False):
    try:
        ...
        outputextractFileName = "../" + app_level.appConfig['DEFAULT']['DATAFOLDER'] + '/extractOutput' + '_' + app_level.currentDateTimeStampString + '_' + str(batch_count) + '.csv'
        ...
        if shall_quote:
            ...
            df.to_csv(outputextractFileName, header=True, index=False, sep=delimiter, columns=col_names_list)  
        ...
        cust_file = file_output_location + "/" + file_name + '_' + app_level.currentDateTimeStampString + '_' + str(batch_count) + '.csv'
